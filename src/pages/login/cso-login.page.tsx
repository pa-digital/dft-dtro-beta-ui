  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.something}>
        <TextComponent type={TypographyType.MainHeading} content="Welcome to the CSO portal" />
        <TextComponent type={TypographyType.Description} content="Enter your details to log in." />
